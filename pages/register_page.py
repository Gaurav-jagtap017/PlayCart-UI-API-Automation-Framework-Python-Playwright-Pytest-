...
class RegisterPage(BasePage):
    def __init__(self, page: Page):
        super().__init__(page)
        self.unique_id = uuid.uuid4().hex[:4]
        ...
        self.username_text= f"abcd{self.unique_id}"
        self.email_text= f"abcd{self.unique_id}@test.com"
        self.password_text = f"RandomPass@123{self.unique_id}"
        # Page-2
    ...
    def goto_register_page(self):
        logger.info("Started with goto_register_page")
    ...
    def enter_details_and_create_user(self):
        logger.info("Started with enter_details_and_create_user")
        self.mr_radio_button.click()
        self.password.fill(self.password_text)
        ...
        logger.info("Ends with enter_details_and_create_user.")
        return self
